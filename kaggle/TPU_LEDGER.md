...
| 2026-09-02 02:59 | h-ghost-h1jax-room05b-e2 | v1 | (running, est 80) | second epoch of the room mix from the pre-cooldown 0.5B checkpoint (375.8M), cooled over the last 10%; does a second pass improve room loss and voice without costing retention |
| 2026-09-02 03:33 | h-ghost-h1jax-room05b-e2-v3 | v1 | (queued behind e2, est 80) | same as e2 but on corpus-v1.3-room (scenes A x6 + B x8): the scene effect at matched compute |
