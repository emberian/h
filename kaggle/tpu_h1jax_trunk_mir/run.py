...
RUN_NAME = os.environ.get("HGHOST_CPT_RUN_NAME", "trunk-mir0.4-lr1e-4-seed0-b32")
...
PER_CHIP = int(os.environ.get("HGHOST_CPT_PER_CHIP", "32"))
...
SAVE_TOKENS = [
    ...
    for v in os.environ.get(
        ...
        "10000000,30000000,100000000,200000000",
    ).split(",")
    if v
]
...
MIR_WEIGHT = float(os.environ.get("HGHOST_CPT_MIR_WEIGHT", "0.4"))  # 0 = plain NTP
