...
SHAPES = os.environ.get("HGHOST_GATE_SHAPES", "1x128r,4x512r")
...
WATCHDOG_MINUTES = float(os.environ.get("HGHOST_WATCHDOG_MINUTES", "15"))
HARD_MAX_MINUTES = float(os.environ.get("HGHOST_GATE_MAX_MINUTES", "25"))
