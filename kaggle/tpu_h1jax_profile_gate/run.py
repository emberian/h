"""h1jax TPU profile gate: measure real Falcon-H1-Tiny training throughput on v5e-8.
...
OUTPUT = Path(os.environ.get("HGHOST_OUTPUT", "/kaggle/working/h1jax-profile-gate"))
...
SHAPES = os.environ.get("HGHOST_GATE_SHAPES", "16x512,32x512,64x512r,8x1024")
...
SANITY_STEPS = int(os.environ.get("HGHOST_SANITY_STEPS", "40"))
...
HBOX_BASE_EVAL = {
    "loss": 3.745613,
    "accuracy": 0.349426,
}  # research/results/hbox-cpt-10m.md
