...
RUN_NAME = os.environ.get("HGHOST_CPT_RUN_NAME", "room05b-e3-decay10")
...
TOTAL_TOKENS = int(os.environ.get("HGHOST_CPT_TOTAL_TOKENS", "1170291218"))
...
BRANCH_FROM = os.environ.get(
    "HGHOST_CPT_BRANCH_FROM", "/kaggle/input/**/room05b-e2-v3-decay10/tokens-000752156672/trainer_state.json"
