...
RUN_NAME = os.environ.get("HGHOST_CPT_RUN_NAME", "leaf-s1-e4-decay10")
...
TOTAL_TOKENS = int(os.environ.get("HGHOST_CPT_TOTAL_TOKENS", "1535061369"))
...
BRANCH_FROM = os.environ.get(
    "HGHOST_CPT_BRANCH_FROM", "/kaggle/input/**/trunk-wsd-lr1e-4-seed1/tokens-001497620848/trainer_state.json"
