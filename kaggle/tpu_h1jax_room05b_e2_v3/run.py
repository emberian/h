...
RUN_NAME = os.environ.get("HGHOST_CPT_RUN_NAME", "room05b-e2-v3-decay10")
...
TOTAL_TOKENS = int(os.environ.get("HGHOST_CPT_TOTAL_TOKENS", "793690394"))
...
DECAY_TOKENS = int(
    os.environ.get("HGHOST_CPT_DECAY_TOKENS", "41790697")
