...
RUN_NAME = os.environ.get("HGHOST_CPT_RUN_NAME", "room05b-e2-v5-replay-decay10")
...
TOTAL_TOKENS = int(os.environ.get("HGHOST_CPT_TOTAL_TOKENS", "854694008"))
...
MAX_MINUTES = float(os.environ.get("HGHOST_CPT_MAX_MINUTES", "120"))
...
DECAY_TOKENS = int(
    os.environ.get("HGHOST_CPT_DECAY_TOKENS", "47891058")
...
ROLE_WEIGHTS = [
    float(x) for x in os.environ.get("HGHOST_CPT_ROLE_WEIGHTS", "").split(",") if x.strip()
]
